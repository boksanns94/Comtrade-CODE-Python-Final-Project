...
# Creates a chess piece class that shows what team a piece is on, what type of piece it
# is and whether or not it can be killed by another selected piece.
class Piece:
...
## Checks a 5x5 grid around the piece and uses pythagoras to see if if a move is valid.
# Valid moves will be a distance of sqrt(5) from centre
